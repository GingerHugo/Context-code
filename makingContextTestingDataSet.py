...
def ExtractMain(argv):
        ...
        outputFile = './Entry_processed/Context_testing/'
        ...
        for polar in PolarizedSet:
                file1 = segFile + 'Segmented_Entry_' + polar + '_testing.txt'
                file3 = posFile + 'POSTagged_Entry_' + polar + '_testing.txt'
                file2 = outputFile + 'Context_Entire_Doc' + '_' + polar + '_testing.txt'
