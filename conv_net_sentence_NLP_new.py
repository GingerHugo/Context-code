...
def train_conv_net(datasets,
        ...
        img_w = word vector length (400 for word2vec)
...
if __name__=="__main__":
        ...
        vectorAddress = "{}/New_{}lexicon.txt".format(path, preposfix)
        print "loading word vector..."
        U = np.loadtxt(vectorAddress, dtype = "float32")
        print "loading testing vector..."
        vectorAddress = "{}/New_Clause_{}testing.txt".format(path, preposfix)
        testing = np.loadtxt(vectorAddress, dtype = "int32")
        # print U.shape
        mode= sys.argv[2]
        ...
        EpochList = [5, 25]
        for Times_of_epochs in EpochList:
                for methodType in fileAddress:
                        print "loading training data..."
                        File1 = "{}/New_Clause_{}{}training.txt".format(path, methodType[1], preposfix)
                        ...
                        result_vector = train_conv_net(datasets,
                                                                                  ...
                                                                                  batch_size=50,
                                                                                  dropout_rate=[0.5])
                        outputFeatureAddress = "./result/New_Clause_{}{}testing_{}epochs_Result.txt".format(methodType[1], preposfix, Times_of_epochs)
